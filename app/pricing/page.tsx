...
const plans = [
  {
    ...
    popular: false,
    features: [
      { label: "3 prompts / mois", ok: true },
      { label: "Toutes les catégories", ok: true },
      { label: "Affinage supplémentaire", ok: true },
      { label: "Image & texte de référence", ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Affinage supplémentaire", ok: true },
      { label: "Image & texte de référence", ok: true },
      { label: "Historique des prompts", ok: true },
      { label: "Prompts en anglais + français", ok: true },
      { label: "Génération haute qualité", ok: false },
    ] as Feature[],
  },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Image & texte de référence", ok: true },
      { label: "Prompts en anglais + français", ok: true },
      { label: "Génération haute qualité (Sonnet)", ok: true },
    ] as Feature[],
  },
];
